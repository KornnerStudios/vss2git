namespace Hpdi.Vss2Git
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.includeIgnoredFilesCheckbox = new System.Windows.Forms.CheckBox();
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.outputGroupBox.Controls.Add(this.includeIgnoredFilesCheckbox);
			...
			// 
			this.includeIgnoredFilesCheckbox.AutoSize = true;
			this.includeIgnoredFilesCheckbox.Location = new System.Drawing.Point(422, 149);
			this.includeIgnoredFilesCheckbox.Name = "includeIgnoredFilesCheckbox";
			this.includeIgnoredFilesCheckbox.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.includeIgnoredFilesCheckbox.Size = new System.Drawing.Size(121, 17);
			this.includeIgnoredFilesCheckbox.TabIndex = 13;
			this.includeIgnoredFilesCheckbox.Text = "Include Ignored files";
			this.includeIgnoredFilesCheckbox.UseVisualStyleBackColor = true;
			// 
			// MainForm
			// 
